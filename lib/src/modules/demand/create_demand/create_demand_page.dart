...
class CreateDemandPage extends StatefulWidget {
  @override
  _CreateDemandPageState createState() => _CreateDemandPageState();
}

class _CreateDemandPageState extends State<CreateDemandPage> {
  ...
  Widget form() {
    return Column(
      children: <Widget>[
        _textFieldDefault(Icons.date_range, 'Data', 'Data do serviço',
            'Data que o serviço sera executado.', _txtDate),
        SizedBox(
          height: 10,
        ),
        _textFieldDefault(Icons.access_time, 'Hora', 'Hora do serviço',
            'Hora que o serviço sera executado.', _txtHour),
        SizedBox(
          height: 10,
        ),
        _textFieldDefault(
