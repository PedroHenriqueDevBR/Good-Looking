  ...
  Widget form() {
    return Column(
      children: <Widget>[
        ...
        _textFieldDefault(Icons.phone_iphone, 'Contato', 'Melhor contato',
            'O contato principal do(a) ajudante.', _txtPhone),
        SizedBox(
          height: 10,
        ),
        _textFieldDefault(Icons.mail_outline, 'E-Mail', 'E-mail principal',
            'O e-mail principal do(a) ajudante.', _txtMail),
        SizedBox(
          height: 10,
        ),
        _textFieldDefault(
