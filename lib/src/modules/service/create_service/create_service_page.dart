...
class _CreateServicePageState extends State<CreateServicePage> {
  ...
  Widget form() {
    return Column(
      children: <Widget>[
        _textFieldDefault(Icons.shopping_basket, 'Nome', 'Nome do servico',
            'Nome unico para o servico cadastrado.', _txtName),
        SizedBox(
          height: 10,
        ),
        _textFieldDefault(
        ...
        _textFieldDefault(Icons.attach_money, 'Preco', 'Valor cobrado',
            'O valor que sera cobrado pelo servico.', _txtPrice),
        SizedBox(
          height: 10,
        ),
        _textFieldDefault(Icons.monetization_on, 'Custos', 'Custos do servicos',
            'Custos inclusos para realizar o servico.', _txtCostService),
      ],
    );
  }
